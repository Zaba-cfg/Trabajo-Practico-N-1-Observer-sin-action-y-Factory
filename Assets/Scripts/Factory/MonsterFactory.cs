...
public class MonsterFactory : MonoBehaviour, IMonsterFactory
{
    ...
    public MonsterBase CreateMonster(MonsterDataSO monsterData, Vector2 spawnPosition)
    {
        GameObject instance = Instantiate(monsterData.Prefab, spawnPosition, Quaternion.identity, monstersContainer);
